...
if (!empty($_POST)) {
  ...
  $valid = true;
    ...
    $sql = "INSERT INTO `genero` (`Nombre_Genero`, `Status`) VALUES (?, ?)";
    $values=array($name, 1);    
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      ...
                      <input type="text" class="form-control has-feedback-left" name="nombre" placeholder="Nombre del género">
...
if ($inserted) {
  ...
  swal({
    title: 'Registro',
    text: 'El género fue agregado exitosamente',
    type: 'success',
