...
if (!empty($_POST)) {
  ...
  */
	...
	// insert data
	if ($valid) {
		$sql = "UPDATE `tarea` SET `Nombre_Tarea`=?,`Descripcion_Tarea`=?,`Fecha_Entrega`=? WHERE Id_Tarea=?";
    $values=array($name, $descripcion, $fechaentrega, $id);
	...
	$sql="SELECT `Nombre_Tarea`, `Descripcion_Tarea`, `Fecha_Entrega` FROM `tarea` WHERE Id_Tarea=?";
  $values=array($id);
  $datos=Database::getRow($sql, $values);
   
  $name = $datos['Nombre_Tarea'];
  $descripcion = $datos['Descripcion_Tarea'];
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          <input type="text" value="<?php print($name); ?>" class="form-control has-feedback-left" name="name" placeholder="Nombre de la Actividad">
                        ...
                        <div class="form-group">
                          <label>Fecha de Entrega*</label>
                            <div class='input-group date' id='myDatepicker'>
                              ...
                              <input required="required" type='text' value="<?php print($fechaentrega); ?>" class="form-control" name="fechaentrega" />
                  ...
                  <textarea name="descr" id="descr" style="" class="form-control"><?php print($descripcion); ?></textarea>
