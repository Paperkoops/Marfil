...
<html lang="en">
  <head>
    ...
    <title>Agregar nuevo periodo </title>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel" style="">
                  <div class="x_title">
                    <h2>Nuevo periodo <small>Rellene la información por favor</small></h2>
                  ...
                  <div class="x_content">
                      ...
                      <div class="col-md-4">
                        <br>
                        <label>Intervalo de tiempo para el nuevo periodo *</label>
                            ...
                            <div class="control-group">
                              <div class="controls">
                                <div class="input-prepend input-group">
                                  ...
                                  <input type="text" style="width: 200px" name="desde" id="reservation" class="form-control" value="01/01/2017 - 01/25/2017" />
                                </div>
                              </div>
                            </div>
                          </fieldset>
