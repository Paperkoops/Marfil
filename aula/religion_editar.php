...
if (!empty($_POST)) {
  ...
  $valid = true;
    ...
    $sql = "UPDATE `religion` SET `Nombre_Religion`=?, `Status`=? WHERE Id_Religion=?";
	...
	$sql="SELECT Id_Religion, Nombre_Religion FROM religion WHERE Id_Religion=?";
  $values=array($id);
  $datos=Database::getRow($sql, $values);
   
  $id = $datos['Id_Religion'];
  $name = $datos['Nombre_Religion'];
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" value="<?php print($name); ?>" name="nombre" placeholder="Nombre de la Religión">
                        <span class="fa fa-angle-double-right form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <button type="button" class="btn btn-primary" href="religion.php">Cancelar</button>
