                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="number" id="DistanciaAlumno" name="number" required="required" data-validate-minmax="10,100" class="form-control has-feedback-left col-md-7 col-xs-12">
