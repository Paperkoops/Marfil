                    ...
                    <div class="col-xs-3">
                      ...
                      <?php
                        ...
                        foreach ($datos as $fila) 
                        {
                          ...
                          if ($patata == 1) {
                            $menu.="<li class='active'><a href='#$fila[Id_Periodo]' data-toggle='tab'>Periodo $patata </a>
                            </li>";
                          } else {
                            $menu.="<li><a href='#$fila[Id_Periodo]' data-toggle='tab'>Periodo $patata</a>
                            </li>";
                          }
                    ...
                    <div class="col-xs-9">
                      ...
                      <?php
                        ...
                        foreach ($datos as $fila) 
                        {
                          ...
                          if ($patata == 1) {
                            $menu.="<div class='tab-pane active' id='$fila[Id_Periodo]'>
                            ...
                            $menu.="<div class='tab-pane' id='$fila[Id_Periodo]'>
                            <p class='lead'>Periodo $patata</p>
                            <p><small>Desde: $fila[desde] Hasta: $fila[hasta]</small></p>
                            <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher
                              synth. Cosby sweater eu banh mi, qui irure terr.</p>
                          ...
                          ";
                          $sql="SELECT * FROM tarea WHERE Id_Periodo=? AND Status=?";
                          $values=array($fila['Id_Periodo'], 1);
                          ...
                          foreach ($datos2 as $fila2) {
                            ...
                            <td><a href='#' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Editar </a>
                            </td>
                          </tr>
                            ";
                            $zoe = $zoe + 1;
                          ...
                          if ($zoe!=3) {
                            if ($kled < 2) {
                              for($kled; $kled <= 1; $kled++){
                                ...
                                <td>35%</td>
                                <td>Sin Asignar</td>
                                <td><a href='agregar_tarea.php' class='btn btn-success btn-xs'><i class='fa fa-plus-circle'></i> Asignar </a>
                                </td>
                              </tr>
                                ";
                                $zoe++;
